        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav">
                        <img src="<?= base_url('assets/img/Logo DJPb Vertical.png'); ?>" alt="Logo DJPb Vertical" width="140" height="120" class="logo-djpb">
                    </ul>
                    <ul class="navbar-nav">
                        <img src=" <?= base_url('assets/img/Indonesian Treasury-01.png'); ?>" alt="Logo INTRESS 3d" width="180" height="50" class="logo-intress">
                    </ul>
                </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse navbar-light mt-5" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-divider">
                                <a href="https://drive.google.com/file/d/1BzvmWOjn2VmNlkTkfpttde83kkL9oZJ0/view?usp=sharing" target="_blank">Manual Book</a>
                            </li>
                        </ul>
                    </div>
                </nav>
