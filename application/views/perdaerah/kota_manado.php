...
<script type="text/javascript">
    ...
    function handleQueryResponse(response) {
        ...
        document.getElementById("perbar_real_dau").style.width = dataTable.getValue(6, 3).replace(/ /g, "");
        ...
        document.getElementById("perbar_real_dbh_tot").style.width = dataTable.getValue(6, 6).replace(/ /g, "");
        ...
        document.getElementById("perbar_real_dd_tot").style.width = dataTable.getValue(6, 13).replace(/ /g, "");
        ...
        document.getElementById("perbar_df").style.width = dataTable.getValue(6, 10).replace(/ /g, "");
        ...
        document.getElementById("perbar_real_bos_tot").style.width = dataTable.getValue(6, 16).replace(/ /g, "");
        ...
        document.getElementById("perbar_real_bopp_tot").style.width = dataTable.getValue(6, 19).replace(/ /g, "");
        ...
        document.getElementById("perbar_real_bopk_tot").style.width = dataTable.getValue(6, 22).replace(/ /g, "");
    }
</script>
