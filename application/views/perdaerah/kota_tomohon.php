...
<script type="text/javascript">
    ...
    function handleQueryResponse(response) {
        ...
        document.getElementById("perbar_real_dau").style.width = dataTable.getValue(7, 3).replace(/ /g, "");
        ...
        document.getElementById("perbar_real_dbh_tot").style.width = dataTable.getValue(7, 6).replace(/ /g, "");
        ...
        document.getElementById("perbar_real_dd_tot").style.width = dataTable.getValue(7, 13).replace(/ /g, "");
        ...
        document.getElementById("perbar_df").style.width = dataTable.getValue(7, 10).replace(/ /g, "");
        ...
        document.getElementById("perbar_real_bos_tot").style.width = dataTable.getValue(7, 16).replace(/ /g, "");
        ...
        document.getElementById("perbar_real_bopp_tot").style.width = dataTable.getValue(7, 19).replace(/ /g, "");
        ...
        document.getElementById("perbar_real_bopk_tot").style.width = dataTable.getValue(7, 22).replace(/ /g, "");
    }
</script>
