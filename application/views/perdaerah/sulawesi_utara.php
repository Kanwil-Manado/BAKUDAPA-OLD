...
<script type="text/javascript">
    ...
    function handleQueryResponse(response) {
        ...
        document.getElementById("per_real_dau").innerHTML = dataTable.getValue(2, 3).replace(/ /g, "");
        document.getElementById("perbar_real_dau").style.width = dataTable.getValue(2, 3).replace(/ /g, "");
        ...
        document.getElementById("per_real_dbh_tot").innerHTML = dataTable.getValue(2, 6).replace(/ /g, "");
        document.getElementById("perbar_real_dbh_tot").style.width = dataTable.getValue(2, 6).replace(/ /g, "");
        ...
        document.getElementById("per_real_dd_tot").innerHTML = dataTable.getValue(2, 13).replace(/ /g, "");
        document.getElementById("perbar_real_dd_tot").style.width = dataTable.getValue(2, 13).replace(/ /g, "");
        ...
        document.getElementById("per_df").innerHTML = dataTable.getValue(2, 10).replace(/ /g, "");
        document.getElementById("perbar_df").style.width = dataTable.getValue(2, 10).replace(/ /g, "");
        ...
        document.getElementById("per_real_bos_tot").innerHTML = dataTable.getValue(2, 16).replace(/ /g, "");
        document.getElementById("perbar_real_bos_tot").style.width = dataTable.getValue(2, 16).replace(/ /g, "");
        ...
        document.getElementById("per_real_bopp_tot").innerHTML = dataTable.getValue(2, 19).replace(/ /g, "");
        document.getElementById("perbar_real_bopp_tot").style.width = dataTable.getValue(2, 19).replace(/ /g, "");
        ...
        document.getElementById("per_real_bopk_tot").innerHTML = dataTable.getValue(2, 22).replace(/ /g, "");
        document.getElementById("perbar_real_bopk_tot").style.width = dataTable.getValue(2, 22).replace(/ /g, "");
    }
</script>
